...
<div className="flex w-full">
 ...
 >
  {
    message.type ==="text" && (<div className={`text-white px-2 py-[5px] tex-sm rounded-md flex gap-2 items-end max-w-[45%] ${message.senderId === currentChatUser.id ? "bg-incoming-background" : "bg-outgoing-background"}`}>
